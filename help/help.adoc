...
+
NOTE: Makecert.exe is included with Visual Studio and Windows SDK installations. For more information, see link:http://msdn.microsoft.com/en-us/library/bfsktky3(VS.80).aspx[Microsoft's Makecert.exe page].

. To upload the Windows certificate to Windows Azure, see link:https://azure.microsoft.com/en-us/documentation/articles/cloud-services-configure-ssl-certificate/[How to Add a Management Certificate to a Windows Azure Subscription].
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/configuration-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/create-or-update-database.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/delete-database.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/create-or-update-network-security-group.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/delete-network-security-group.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/create-or-update-network-security-rule.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/delete-network-security-rule.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/create-or-update-subnet.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/delete-subnet.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/create-vnet.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/delete-vnet.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/create-vm.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/start-vm.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/restart-vm.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/stop-vm.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/delete-vm.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/sql-operations.png[image]
...
image::cloudbees-common::cd-plugins/ec-azure/parameters/nosql-operations.png[image]
