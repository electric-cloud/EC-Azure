    ...
    extends ListBase
{
    ...
    private AzureConfigList m_configList;

    //~ Constructors -----------------------------------------------------------

    public ConfigurationList()
    {
        super("ecgc", "Windows Azure Configurations", "All Configurations");
        m_configList = new AzureConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        AzureConfigListLoader loader = new AzureConfigListLoader(m_configList, this,
                new ChainedCallback() {
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.addActualParameter("connection", configName);
    ...
    private void loadList()
    {
        ...
        if (!m_configList.isEmpty()) {
            listTable.addHeaderRow(true, "Configuration Name", "Description");
        }
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            // Description
            String configDesc      = m_configList.getConfigDesc(configName);
            Label  configDescLabel = new Label(configDesc);
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the Azure configuration '"
                            + configName + "'?") {
            ...
            listTable.addRow(configNameLabel, configDescLabel, actions);
        }
    ...
    private void waitForJob(final String jobId)
    {
        CgiRequestProxy     cgiRequestProxy = new CgiRequestProxy(
                getPluginName(), "azureMonitor.cgi");
