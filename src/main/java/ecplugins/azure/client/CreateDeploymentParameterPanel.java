...
public class CreateDeploymentParameterPanel extends ComponentBase implements
        ParameterPanel, ParameterPanelProvider, HasInitCallback {
    // ~ Static fields/initializers
    // ---------------------------------------------
    private static UiBinder<Widget, CreateDeploymentParameterPanel> s_binder = GWT
            .create(Binder.class);
    ...
    // --------------------------------------------------------
    @UiField
    FormBuilder create_deployment_ParameterForm;
    ...
    public Widget doInit() {
        ...
        create_deployment_ParameterForm
                .addRow(true,
                        "Configuration:",
        ...
        create_deployment_ParameterForm
                .addRow(false,
                        "Name:",
                        "Represents the name of an extended deployment property. ",
                        NAME, "", name_box);
        create_deployment_ParameterForm
                .addRow(false,
                        "Value:",
    ...
    public boolean validate() {
        ...
        if (StringUtil.isEmpty(create_deployment_ParameterForm.getValue(
        ...
        if (StringUtil.isEmpty(create_deployment_ParameterForm.getValue(VALUE)
                .trim())
                & !StringUtil.isEmpty(create_deployment_ParameterForm.getValue(
                        NAME).trim())) {
    ...
    protected void updateRowVisibility() {
        ...
        create_deployment_ParameterForm.setRowVisible(
                VALUE,
                !StringUtil.isEmpty(create_deployment_ParameterForm.getValue(
                        NAME).trim()));
    }
    ...
    public Map<String, String> getValues() {
        ...
        Map<String, String> create_deployment_FormValues = create_deployment_ParameterForm
                .getValues();
        ...
        actualParams.put(LABEL,
                create_deployment_FormValues.get(LABEL));
    ...
    public void setActualParameters(Collection<ActualParameter> actualParameters) {
        ...
        for (String key : new String[] { CONNECTION_CONFIG, SERVICE_NAME,
                DEPLOYMENT_SLOT, DEPLOYMENT_NAME, PACKAGE_URL,
                DEPLOYMENT_CONFIGURATION, LABEL, START_DEPLOYMENT,
                TREAT_WARNINGS_AS_ERROR, NAME, VALUE, RESULTS_LOCATION_OUTPSP, TAG_OUTPP,
                JOB_STEP_TIMEOUT }) {
        ...
        create_deployment_ParameterForm.setValue("TREAT_WARNINGS_AS_ERROR",                treat_warnings_as_error);
    ...
    // ~ Inner Interfaces
    // -------------------------------------------------------
    interface Binder extends UiBinder<Widget, CreateDeploymentParameterPanel> {
    }
}
