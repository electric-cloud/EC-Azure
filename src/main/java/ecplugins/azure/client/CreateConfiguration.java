...
/**
 * Create vCloudDirector Configuration.
 */
    ...
    extends InternalFormBase
{
    ...
    {
        super("New Windows Azure Configuration", "Windows Azure Configurations");
    ...
    @Override protected void load()
    {
        ...
        loader.setCustomEditorPath("/plugins/EC-Azure"
                + "/project/forms/CreateConfigForm");
        loader.load();
        clearStatus();
    }
