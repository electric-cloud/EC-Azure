...
public class CreateStorageAccountParameterPanel
        ...
        ParameterPanelProvider
{
    ...
    // ~ Static fields/initializers
    // ---------------------------------------------
    private static UiBinder<Widget, CreateStorageAccountParameterPanel> s_binder =
    ...
    // ~ Instance fields
    // --------------------------------------------------------
    @UiField FormBuilder create_storage_account_ParameterForm;
    ...
    @Override public Widget doInit()
    {
        ...
        create_storage_account_ParameterForm.addRow(true, "Label:",
        ...
        create_storage_account_ParameterForm.addRow(false, "Description:",
            ...
            new TextBox());
        create_storage_account_ParameterForm.addRow(false, "Location:",
            "The location where the storage account is created. Required if 'Affinity Group' is not specified.",
            LOCATION, "", location_box);
        create_storage_account_ParameterForm.addRow(false, "Affinity Group:",
        ...
        create_storage_account_ParameterForm.addRow(false,
        ...
        create_storage_account_ParameterForm.addRow(false, "Name:",
            "Represents the name of an extended storage account property. ",
            NAME, "", name_box);
        create_storage_account_ParameterForm.addRow(false, "Value:",
        ...
        create_storage_account_ParameterForm.addRow(false, "JobStep Timeout:",
    ...
    @Override public boolean validate()
    {
        boolean validationStatus =
            create_storage_account_ParameterForm.validate();

        // CONNECTION_CONFIG required.
        if (StringUtil.isEmpty(
                    create_storage_account_ParameterForm.getValue(
                                                        CONNECTION_CONFIG)
                                                    .trim())) {
        ...
        // LABEL required.
        if (StringUtil.isEmpty(
                    create_storage_account_ParameterForm.getValue(LABEL)
                                                    .trim())) {
            create_storage_account_ParameterForm.setErrorMessage(LABEL,
        ...
        if (StringUtil.isEmpty(
                    create_storage_account_ParameterForm.getValue(
                                                        SERVICE_NAME)
                                                    .trim())) {
            create_storage_account_ParameterForm.setErrorMessage(SERVICE_NAME,
                "This Field is required.");
            validationStatus = false;
        }
        ...
        if (StringUtil.isEmpty(
                    create_storage_account_ParameterForm.getValue(LOCATION)
                                                    .trim())
                & StringUtil.isEmpty(
                    create_storage_account_ParameterForm.getValue(
                                                        AFFINITY_GROUP)
                                                    .trim())) {
            create_storage_account_ParameterForm.setErrorMessage(LOCATION,
        ...
        if (StringUtil.isEmpty(
                ...
                & StringUtil.isEmpty(
                    create_storage_account_ParameterForm.getValue(LOCATION)
                                                    .trim())) {
            create_storage_account_ParameterForm.setErrorMessage(AFFINITY_GROUP,
        ...
        if (StringUtil.isEmpty(
                    create_storage_account_ParameterForm.getValue(VALUE)
                                                    .trim())
                & !StringUtil.isEmpty(
                    create_storage_account_ParameterForm.getValue(NAME)
                                                    .trim())) {
    ...
    protected void updateRowVisibility()
    {
        create_storage_account_ParameterForm.setRowVisible(AFFINITY_GROUP,
            StringUtil.isEmpty(
                create_storage_account_ParameterForm.getValue(LOCATION)
                                                    .trim()));
        create_storage_account_ParameterForm.setRowVisible(LOCATION,
            StringUtil.isEmpty(
                create_storage_account_ParameterForm.getValue(AFFINITY_GROUP)
                                                    .trim()));
        create_storage_account_ParameterForm.setRowVisible(VALUE,
            !StringUtil.isEmpty(
                create_storage_account_ParameterForm.getValue(NAME)
                                                    .trim()));
    }
    ...
    @Override public Map<String, String> getValues()
    {
        ...
        Map<String, String> create_storage_account_FormValues =
            create_storage_account_ParameterForm.getValues();
            ...
            Collection<ActualParameter> actualParameters)
    {
        ...
        create_storage_account_ParameterForm.setValue("GEO_REPLICATION_ENABLED",
            geo_replication);
        updateRowVisibility();
    }
    ...
    // -------------------------------------------------------
    interface Binder
        extends UiBinder<Widget, CreateStorageAccountParameterPanel> { }
}
