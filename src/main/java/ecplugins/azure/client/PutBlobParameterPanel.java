...
public class PutBlobParameterPanel
        ...
        ParameterPanelProvider
{
    ...
    // ~ Instance fields
    // --------------------------------------------------------
    @UiField FormBuilder put_blob_ParameterForm;
    ...
    @Override public Widget doInit()
    {
        ...
        put_blob_ParameterForm.addRow(false, "Blob sequence number:",
        ...
        put_blob_ParameterForm.addRow(true,
        ...
        put_blob_ParameterForm.addRow(false, "JobStep Timeout:",
    ...
    @Override public boolean validate()
    {
        ...
        if (StringUtil.isEmpty(
                    put_blob_ParameterForm.getValue(CONNECTION_CONFIG)
                                      .trim())) {
        ...
        if (StringUtil.isEmpty(
                    put_blob_ParameterForm.getValue(STORAGE_ACCOUNT)
                                      .trim())) {
        ...
        if (StringUtil.isEmpty(
                    put_blob_ParameterForm.getValue(STORAGE_ACCOUNT_KEY)
                                      .trim())) {
            put_blob_ParameterForm.setErrorMessage(STORAGE_ACCOUNT,
                "This Field is required.");
            validationStatus = false;
        ...
        if (StringUtil.isEmpty(
                    put_blob_ParameterForm.getValue(CONTAINER_NAME)
                                      .trim())) {
        ...
        // BLOB_TYPE required.
        if (StringUtil.isEmpty(
                    put_blob_ParameterForm.getValue(BLOB_TYPE)
                                      .trim())) {
        ...
        if (PAGE_BLOB.equals(type)) {
            ...
            // BLOB_NAME required
            if (StringUtil.isEmpty(
                        put_blob_ParameterForm.getValue(BLOB_NAME)
                                          .trim())) {
            ...
            if (StringUtil.isEmpty(
                        put_blob_ParameterForm.getValue(BLOB_CONTENT_LENGTH)
                                          .trim())) {
            ...
            if (StringUtil.isEmpty(
                        put_blob_ParameterForm.getValue(
            ...
            if (!put_blob_ParameterForm.getValue(BLOB_SEQUENCE_NUMBER)
                                       .trim()
                                       .matches("\\d+")) {
                put_blob_ParameterForm.setErrorMessage(BLOB_SEQUENCE_NUMBER,
            ...
            if (StringUtil.isEmpty(
                        put_blob_ParameterForm.getValue(BLOB_CONTENT)
                                          .trim())) {
            ...
            if (StringUtil.isEmpty(
                        put_blob_ParameterForm.getValue(FILEPATH)
                                          .trim())) {
    ...
    @Override public Map<String, String> getValues()
    {
        ...
        Map<String, String> put_blob_FormValues =
            put_blob_ParameterForm.getValues();
        ...
        actualParams.put(TAG_OUTPP, put_blob_FormValues.get(TAG_OUTPP));
    ...
    // -------------------------------------------------------
    interface Binder
        extends UiBinder<Widget, PutBlobParameterPanel> { }
}
